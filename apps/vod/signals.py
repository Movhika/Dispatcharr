...
def mark_vod_profiles_outdated_for_source_content(instance):
    ...
    def mark_outdated():
        ...
        elif isinstance(instance, VODSourceAsset):
            category_keys = set(
                instance.movie_relations.values_list(
                    "m3u_account_id", "category_id"
                )
            ) | set(
                instance.series_relations.values_list(
                    "m3u_account_id", "category_id"
                )
            ) | set(
                instance.episode_relations.values_list(
