    ...
    >
      <Stack gap="md">
        <Alert color="blue" variant="light">
          ...
          stored separately on the canonical movie or series. The original
          TMDB title is always retained, plus the one or two localized titles
          selected below.
        </Alert>
        ...
        <Group justify="space-between">
          ...
          {data.state?.completed_at && (
            <Text size="xs" c="dimmed">
              Last completed:{' '}
              {new Date(data.state.completed_at).toLocaleString()}
            </Text>
          )}
        </Group>
