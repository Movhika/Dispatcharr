...
const VODMetadataPanel = lazy(
  () => import('../components/forms/settings/VODMetadataPanel.jsx')
);
const VODTitleCleanupPanel = lazy(
  () => import('../components/forms/settings/VODTitleCleanupPanel.jsx')
);
    ...
    sections: [
      {
        ...
        label: 'Metadata',
        icon: Video,
        Component: VODMetadataPanel,
      },
      {
        id: 'vod-title-cleanup',
        label: 'Title cleanup',
        icon: Eraser,
        Component: VODTitleCleanupPanel,
      },
    ],
  },
  {
